...
ui <- navbarPage(
    ...
    title = "VN 03 Stocks Porfolio: Long Term",
    id = "tab",
    selected = "perfTab",
    ...
    tabPanel(
        ...
        sidebarLayout(
            sidebarPanel(
                selectizeInput("assets", "Select Assets", choices = c("FPT", "VCB", "BID"), selected = c("FPT", "VCB", "BID"), multiple = TRUE),
            ),
    ...
    tabPanel(
        ...
        sidebarLayout(
            sidebarPanel(
                sliderInput("initEqSlider", "Initial Equity, $", min = 10000, max = 500000, step = 1000, value = 10000),
                fluidRow(
                    column(6, 
                ...
                fluidRow(
                    column(6, 
                        sliderInput("targetVolSlider", "Target Asset Volatility, %", min = 1, max = 15, step = 1, value = 5)
                    ),
                    column(6, 
